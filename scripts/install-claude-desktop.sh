...
# Usage: curl -fsSL https://github.com/haggis-labs/attio-mcp-server/raw/refs/heads/feature/issue-3-publish-scoped-package/scripts/install-claude-desktop.sh | bash
